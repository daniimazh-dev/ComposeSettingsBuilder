...
fun SettingsScreen(
    ...
    val lastNavigateAction by model.lastNavigateAction.collectAsState()
    val screenStack by model.screenStack.collectAsState()
    val screenHeap by model.screenHeap.collectAsState()
